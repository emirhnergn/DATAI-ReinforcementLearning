...
class DQLAgent:
    ...
    def __init__(self):
        ...
        self.state_size  = 4 # distance [(playerx-m1x),(playery-m1y),(playerx-m2x),(playerx-m2y)]
    ...
    def build_model(self):
        ...
        model.add(Dense(units=48,input_dim=self.state_size,activation="relu"))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        pygame.display.set_caption("RL Game Episode: "+str(t))
